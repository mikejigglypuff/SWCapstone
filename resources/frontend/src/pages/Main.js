...
const Main = () => {
    ...
    const fetcFreeBoardData = async() => {
        try{
            const responses = await axios.get('https://www.healthintalk.net/board/자유게시판');
    ...
    const fetchShareBoardData = async() => {
        try{
            const responses = await axios.get('https://www.healthintalk.net/board/식단&운동공유게시판');
    ...
    const fetchBoardData = async() => {
        try{
            const responses = await axios.get('https://www.healthintalk.net/board/질문게시판');
